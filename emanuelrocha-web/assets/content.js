...
export const copies = {
    ca: {
        ...
        proseHTML: `Al punt on eliminem el soroll de la teva comunicació comercial. Si la situació actual és insostenible, la millor opció és <button type="button" class="btn-inline-option" data-action="narrative" data-intent="A">passar a l’acció ara mateix</button>. Si intueixes que alguna cosa falla però l’operativa diària t’absorbeix, et convido a <button type="button" class="btn-inline-option" data-action="narrative" data-intent="B">veure com enfoco el meu treball</button> per descobrir què puc fer per tu.`,
        A: routeContent.ca.A,
        B: routeContent.ca.B
    },
    es: {
        ...
        proseHTML: `Al punto donde eliminamos el ruido de tu comunicación comercial. Si la situación actual es insostenible, la mejor opción es <button type="button" class="btn-inline-option" data-action="narrative" data-intent="A">pasar a la acción ahora mismo</button>. Si intuyes que algo falla pero la operativa diaria te absorbe, te invito a <button type="button" class="btn-inline-option" data-action="narrative" data-intent="B">ver cómo enfoco mi trabajo</button> para descubrir qué puedo hacer por ti.`,
        A: routeContent.es.A,
        B: routeContent.es.B
    }
};
